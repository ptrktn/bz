...
cc -O2 -DVISUAL -o matrix matrix.c rgb.c -lm -lgl_s
compilation without graphics:
cc -O2 -o matrix matrix.c rgb.c -lm 
*/
...
#define TIME_PLOT       0
#define RELEASE_RATE    (TIME_END/1000)
#define DEGRADE         0
#define DEGRADE_T       0.05
#define SLABS           0
