...
function j = jac (x, t)
    ...
    # xdot(3) =  -kf(1)*x(1)*x(2)*x(3) + kf(12)*x(15)*x(4) + kf(14)*x(16) + 2*kf(16)*x(11)*x(4) - kf(17)*x(11)*x(3)*x(7) + kf(18)*x(11)*x(2) - kf(19)*x(14)*x(3)*x(7) - kf(2)*x(1)*x(3)*x(6) - kf(3)*x(1)*x(3)**2*x(7) - kf(4)*x(3)*x(6) + 2*kf(5)*x(6)*x(8) - kf(6)*x(3)*x(6)*x(7) + kr(1)*x(4)*x(5) + kr(2)*x(2)**2 + 2*kr(3)*x(2)*x(6) + kr(4)*x(8) + kr(6)*x(5)*x(9)
    ...
    # xdot(3) =  -kf(1)*x(1)*x(2)*x(3) + kf(12)*x(15)*x(4) + kf(14)*x(16) + 2*kf(16)*x(11)*x(4) - kf(17)*x(11)*x(3)*x(7) + kf(18)*x(11)*x(2) - kf(19)*x(14)*x(3)*x(7) - kf(2)*x(1)*x(3)*x(6) - kf(3)*x(1)*x(3)**2*x(7) - kf(4)*x(3)*x(6) + 2*kf(5)*x(6)*x(8) - kf(6)*x(3)*x(6)*x(7) + kr(1)*x(4)*x(5) + kr(2)*x(2)**2 + 2*kr(3)*x(2)*x(6) + kr(4)*x(8) + kr(6)*x(5)*x(9)
    j(3, 3) =  -kf(1)*x(1)*x(2) - kf(17)*x(11)*x(7) - kf(19)*x(14)*x(7) - kf(2)*x(1)*x(6) - 2*kf(3)*x(1)*x(3)*x(7) - kf(4)*x(6) - kf(6)*x(6)*x(7)  ; 
    ...
    # xdot(10) =  2*kf(7)*x(9) - kf(8)*x(10)*x(11) - kf(9)*x(10)*x(12) - kr(7)*x(10)**2
    j(10, 1) =  0  ; 
    ...
    # xdot(12) =  -kf(10)*x(12)**2 + kf(8)*x(10)*x(11) - kf(9)*x(10)*x(12) + 2*kr(10)*x(11)*x(13)
    j(12, 1) =  0  ; 
