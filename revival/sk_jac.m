...
function j = jac (x, t)
    ...
    # xdot(2) =  -kf(1)*x(1)*x(2)*x(3) - kf(13)*x(15)*x(2) - kf(18)*x(11)*x(2) + 2*kf(2)*x(1)*x(3)*x(6) + kf(3)*x(1)*x(3)**2*x(7) + kf(5)*x(6)*x(8) + kr(1)*x(4)*x(5) - kr(2)*x(2)**2 - kr(3)*x(2)*x(6)
    j(2, 17) =  0  ; 
    # xdot(3) =  -kf(1)*x(1)*x(2)*x(3) - kf(11)*x(14)*x(3) + kf(12)*x(15)*x(4) + kf(14)*x(16) + 2*kf(16)*x(11)*x(4) - kf(17)*x(11)*x(3)*x(7) + kf(18)*x(11)*x(2) - kf(19)*x(14)*x(3)*x(7) - kf(2)*x(1)*x(3)*x(6) - kf(3)*x(1)*x(3)**2*x(7) + 2*kf(5)*x(6)*x(8) - kf(6)*x(3)*x(6)*x(7) + kr(1)*x(4)*x(5) - kr(11)*x(15)*x(3) + kr(2)*x(2)**2 + 2*kr(3)*x(2)*x(6) - kr(6)*x(5)*x(9)
